<?php
    ...
    function getArticleContent($id){
        ...
        $requete = $bdd->prepare("SELECT a.titre, a.imgUrl, a.content, a.date, c.nomCategorie, gc.genre, 
            u.nom AS auteurNom, u.prenom AS auteurPrenom, j.nom, j.developpeur, j.editeur, j.dateDeSortie, 
            j.cover, h.console 
                                FROM articles a
        ...
        if($contenuArticle){
            ...
            // Si je n'ai rien reçu, l'id de l'article n'existe pas, je renvoie vers la page d'erreur
